...
// because in real life there may be hundreds of methods and we can forgot to add it into the factory function
//-------------------------------------
// best solution : Object.create()
...
console.log(user3.sing()); // ooh la la re
